...
class ECommerceScreen extends StatelessWidget {
  ...
  Widget _buildProductTile(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Image.asset('assets/textiles.png', fit: BoxFit.fitHeight),
          Expanded(
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
      ...
      children: [
        Row(
          children: const [
            ...
            SizedBox(width: 10),
            Expanded(
              child: DealButton(text: 'Daily Deals', color: Colors.blue),
            ),
          ],
        ),
        ...
        Row(
          children: const [
            ...
            SizedBox(width: 10),
            Expanded(
              child: DealButton(text: 'Last Chance', color: Colors.redAccent),
            ),
          ],
        ),
      ],
...
class DealButton extends StatelessWidget {
  ...
  const DealButton({required this.text, required this.color, super.key});
